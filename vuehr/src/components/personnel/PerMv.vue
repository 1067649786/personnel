  ...
  <div>
    <el-container>
      <el-header style="display: flex;justify-content: space-between;align-items: center;padding-left: 0px">
        <el-button @click="dialogVisible = true" icon="el-icon-plus" type="primary" size="mini">添加调动</el-button>
      ...
      <el-dialog
        ...
        <div style="display: flex;justify-content: flex-start;">
          <el-steps :active="index" direction="vertical">
            ...
            <el-step title="调动后部门"></el-step>
            <el-step title="调动后职位"></el-step>
            <el-step title="调动日期"></el-step>
            <el-step title="调动原因"></el-step>
